...
--
-- Host: localhost:3306
-- Generation Time: May 22, 2023 at 05:27 PM
...
CREATE TABLE `dags` (
  ...
  `map_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jalno` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `dag_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `map_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sit_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(3, 1, 1, 1, 'RS', '32', '45-67', 'SvaBnBP86L.pdf', '34', 1, 1, '2023-05-06 10:07:24', '2023-05-06 10:07:24');
...
(12, '2023_05_16_170148_create_transactions_table', 2);
...
CREATE TABLE `transactions` (
  ...
  `dag_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sit_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `transactions` (`id`, `location_id`, `mouza_id`, `new_mouza_id`, `dag_id`, `map_type`, `jalno`, `dag_no`, `sit_no`, `email`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 1, 'CS', '৭৮৯৪৫৬৪', '১০১ - ১৫০', '২', NULL, 1, 1, '2023-05-15 11:18:22', '2023-05-16 11:18:22'),
(2, 2, 2, 2, 2, 'BRS', '21', '84', '23', 'mdshazzad71973@gmail.com', 1, 1, '2023-05-22 11:01:37', '2023-05-22 11:01:37'),
(3, 1, 1, 1, 3, 'RS', '32', '45-67', '34', 'shazid.dev@gmail.com', 1, 1, '2023-05-22 11:09:58', '2023-05-22 11:09:58');
...
(1, 'আরাফাত', 'প্রিন্ট', 'Super Admin', 'superadmin@gmail.com', '01992327887', '3kvYcArKbN.jpg', NULL, NULL, NULL, '$2y$10$5O2cFNpTMJuMnmYLI6upt.vrFTNx5H2M/Yp.F6GN5MTFrXybPi96S', 'yPmsdZWBIC6kyFY42O5q5tw5LK4q5cbJuWMEQEEVvngb74gphEWOgy6kPCPR', '2023-05-01 15:53:42', '2023-05-01 16:22:46'),
