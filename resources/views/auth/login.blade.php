...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- /Logo -->
            {{-- <h4 class="mb-2">আরাফাত প্রিন্টে স্বাগতম</h4> --}}
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <!-- Email or Username -->
                <div class="mb-3">
                    <label for="input_type" class="form-label">ইমেল বা ইউসারনাম</label>
                    <input type="text"
                        class="form-control @error('email') is-invalid @enderror @error('username') is-invalid @enderror"
                        id="input_type" name="input_type" value="{{ old('input_type') }}" placeholder="আপনার ইমেল বা ইউসারনাম লিখুন"
                        autofocus required />
                    @error('email')
                ...
                <!-- Submit Button -->
                <div class="mb-3">
                    <button class="btn btn-primary d-grid w-100" type="submit">সাইন ইন করুন</button>
                </div>
            </form>
